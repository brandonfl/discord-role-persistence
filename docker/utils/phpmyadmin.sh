...
docker run -d --rm --network discord-role-persistence_default --link bot-mysql -p $PHPMYADMIN_PORT:80 -e PMA_HOST=bot-mysql -e PMA_USER=bot -e PMA_PASSWORD=bot phpmyadmin/phpmyadmin
